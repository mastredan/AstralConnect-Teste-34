            ...
            >
              ...
              <div className="absolute top-4 right-4 z-[70] flex gap-2">
                <Button
                  ...
                  className="bg-[#257b82] hover:bg-[#1e626a] text-white p-2 rounded-full shadow-lg opacity-75"
                  size="sm"
                >
                  <Download size={16} />
                </Button>
                <Button
                  ...
                  className="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow-lg opacity-75"
                  size="sm"
                >
                  <Share2 size={16} />
                </Button>
                <Button
                  onClick={() => setExpandedImage(null)}
                  className="bg-red-500 hover:bg-red-600 text-white p-2 rounded-full shadow-lg opacity-75"
                  size="sm"
                >
                  <X size={16} />
                </Button>
